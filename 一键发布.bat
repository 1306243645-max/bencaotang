...
echo.
echo [3/4] 生成分享海报...
.venv\Scripts\python.exe -c "import sys;sys.path.insert(0,'.');from bots.share_poster import create_poster;create_poster('http://172.20.21.34:8501','山东本草堂中医诊所','本草济世·仁心济世','扫码体验AI舌诊+体质自测+周易面诊+风水+问茶')"
echo.
echo [4/4] 打开成果文件夹...
