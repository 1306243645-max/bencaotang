...
def render():
    ...
    <div style="text-align:center;padding:2rem;background:linear-gradient(135deg,rgba(155,142,196,0.08),rgba(181,168,212,0.05));border-radius:12px;margin-bottom:2rem;">
        ...
        <p style="color:var(--ink-light);">{t('妙手堂汇聚山东及全国著名中医专家，为您提供专业中医健康服务','Expert TCM practitioners providing professional health services')}</p>
    </div>
    ...
    experts = [
        ...
        {"name": t("妙手堂中医团队","BenCao Tang Team"), "title": t("AI问诊知识库专家组","AI Knowledge Expert Panel"), "field": t("中医学 · AI融合","TCM + AI"), "desc": t("18个知识库，涵盖中医全科。","18 knowledge bases, full TCM coverage.")},
    ]
